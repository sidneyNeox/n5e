...
export default class ActiveEffect5e extends ActiveEffect {
    ...
    switch ( a.dataset.action ) {
      case "create":
        return owner.createEmbeddedDocuments("ActiveEffect", [{
          label: game.i18n.localize("N5E.EffectNew"),
  ...
  static prepareActiveEffectCategories(effects) {
    ...
    const categories = {
      temporary: {
        type: "temporary",
        label: game.i18n.localize("N5E.EffectTemporary"),
        effects: []
      },
      passive: {
        type: "passive",
        label: game.i18n.localize("N5E.EffectPassive"),
        effects: []
      },
      inactive: {
        type: "inactive",
        label: game.i18n.localize("N5E.EffectInactive"),
        effects: []
      },
      suppressed: {
        type: "suppressed",
        label: game.i18n.localize("N5E.EffectUnavailable"),
        effects: [],
        info: [game.i18n.localize("N5E.EffectUnavailableInfo")]
      }
    };
