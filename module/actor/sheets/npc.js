...
export default class ActorSheet5eNPC extends ActorSheet5e {
  ...
  _prepareItems(data) {
    ...
    const features = {
      weapons: { label: game.i18n.localize("N5E.AttackPl"), items: [], hasActions: true, dataset: {type: "weapon", "weapon-type": "natural"} },
      actions: { label: game.i18n.localize("N5E.ActionPl"), items: [], hasActions: true, dataset: {type: "feat", "activation.type": "action"} },
