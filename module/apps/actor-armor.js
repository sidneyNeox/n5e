...
export default class ActorArmorConfig extends DocumentSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      classes: ["n5e", "actor-armor-config"],
      template: "systems/n5e/templates/apps/actor-armor.html",
      width: 320,
      height: "auto"
    });
  }
  ...
  /** @inheritdoc */
  get title() {
    return `${game.i18n.localize("N5E.ArmorConfig")}: ${this.document.name}`;
  }
  ...
  async getData() {
    ...
    return {
      ac: ac,
      calculations: CONFIG.N5E.armorClasses,
  ...
  async _onChangeInput(event) {
    ...
    const cfg = CONFIG.N5E.armorClasses[calc];
