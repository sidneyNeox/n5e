...
export default class ActorSkillConfig extends DocumentSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["n5e"],
      template: "systems/n5e/templates/apps/skill-config.html",
      width: 500,
      height: "auto"
    });
  }
  ...
  /** @inheritdoc */
  get title() {
    return `${game.i18n.format("N5E.SkillConfigureTitle", {skill: CONFIG.N5E.skills[this._skillId]})}: ${this.document.name}`;
  }
  ...
  getData(options) {
    return {
      ...
      proficiencyLevels: CONFIG.N5E.proficiencyLevels,
  ...
  _updateObject(event, formData) {
    ...
    if ( !passiveRoll.isDeterministic ) {
      const message = game.i18n.format("N5E.FormulaCannotContainDiceWarn", {
        name: game.i18n.localize("N5E.SkillBonusPassive")
      });
