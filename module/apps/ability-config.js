...
export default class ActorAbilityConfig extends DocumentSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["n5e"],
      template: "systems/n5e/templates/apps/ability-config.html",
      width: 500,
      height: "auto"
    });
  }
  ...
  /** @override */
  get title() {
    return `${game.i18n.format("N5E.AbilityConfigureTitle", {ability: CONFIG.N5E.abilities[this._abilityId]})}: ${this.document.name}`;
  }
  ...
  getData(options) {
    return {
      ...
      labelSaves: game.i18n.format("N5E.AbilitySaveConfigure", {ability: CONFIG.N5E.abilities[this._abilityId]}),
      labelChecks: game.i18n.format("N5E.AbilityCheckConfigure", {ability: CONFIG.N5E.abilities[this._abilityId]}),
      abilityId: this._abilityId,
      proficiencyLevels: {
        0: CONFIG.N5E.proficiencyLevels[0],
        1: CONFIG.N5E.proficiencyLevels[1]
      },
